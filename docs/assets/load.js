function loadem(){
if (localStorage.getItem("EPDN")) { Array.from(document.getElementsByClassName("EPDN")).forEach((index) => { index.innerHTML = sessionStorage.getItem("EPDN") }) }; 
if (localStorage.getItem("EPname")) { Array.from(document.getElementsByClassName("EPname")).forEach((index) => { index.innerHTML = sessionStorage.getItem("EPname") }) }; 
if (localStorage.getItem("WxC")) { Array.from(document.getElementsByClassName("WxC")).forEach((index) => { index.innerHTML = sessionStorage.getItem("WxC") }) } ;
if (localStorage.getItem("PW")) { Array.from(document.getElementsByClassName("PW")).forEach((index) => { index.innerHTML = sessionStorage.getItem("PW") }) } ;
if (localStorage.getItem("login")) { Array.from(document.getElementsByClassName("login")).forEach((index) => { index.innerHTML = sessionStorage.getItem("login") }) } ;
if (localStorage.getItem("Queue")) { Array.from(document.getElementsByClassName("Queue")).forEach((index) => { index.innerHTML = sessionStorage.getItem("Queue") }) } ;
if (localStorage.getItem("Team")) { Array.from(document.getElementsByClassName("Team")).forEach((index) => { index.innerHTML = sessionStorage.getItem("Team") }) } ;
if (localStorage.getItem("POD")) { Array.from(document.getElementsByClassName("POD")).forEach((index) => { index.innerHTML = sessionStorage.getItem("POD") }) } ;
